...
import "../styles/addcar.css";
import { addCar } from "../assets/dummy-data/CarData"; // Import the state management functions
...
const AddCar = () => {
  ...
  const handleSaveChanges = async (e) => {
    e.preventDefault();
    console.log("Car Details Hruuu: \n", carDetails);
    addCar(carDetails); // Use the state management function to add the car
    ...
    if (responseData.success) {
      ...
      await fetch("http://localhost:4000/api/cars/addcar", {
        method: "POST",
        headers: {
          Accept: "application/json",
  ...
  return (
    <div className="Addcar">
      <div className="addcar-wrapper">
        <h2 className="addcar_title">Add Car</h2>
